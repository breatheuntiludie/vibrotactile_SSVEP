...
%time for experiment
OX = zeros(Length_epoch/2, 1);
for local = 1:250
    OX(local, 1) = (local-1)*2;
end;

for Nexp = 1:9
    if (Nexp==3 || Nexp==6 || Nexp==9)
...
for local1 = 1:9
    ...
    St1=['C:\Users\IVAN\Documents\MATLAB\P300+KIH-filter\res_exp\kul\Pz\',num2str(Nexp), '\', num2str(window),'.bmp'];
